  ...
  <div>
    <div class="wrapper">
      ...
      <section class="categories">
        ...
        />
        <p>
          To the layperson, a library “item” can represent many different
          things:
        ...
        <p>
          ...
          published online. As of early February 2020, when this fellowship
          began and I received a bulk data set, the Library had provided access
          to over two million item files. I selected a subset of
          {{ total }} categories (or “formats” in library parlance) to work
          with:
        ...
        <p>
          ...
          every book would be present in <em>Aereo</em> and we’re talking of
          about 1.5 million books here so… skipped this one), audio and music
          (although it would be interesting to explore an interface that would
          combine both audio and images).
        </p>
        <p>
          If you look at the formats available currently in the
          <a href="https://collection.sl.nsw.gov.au/digital">library website</a>
          you will notice only 11 and I have just mentioned {{ total + 3 }}.
          That is because I had access to a bit more granular data about the
          items. This data is not surfaced directly in the site either because
          it is incomplete or otherwise not up to the high standards the library
          has in serving its materials to patrons
          <mark>(need to double-check)</mark>. You will probably see things that
          seem off and that is to be expected. For any questions regarding the
      ...
      <section class="sorting">
        ...
        <p>
          ...
          files were returned by a query done to the library database. It is
          kind of like doing an empty search on a given category and receiving
          results sorted by “relevance”. This relevance is simply a measure of
          different weights given to different parts of the metadata of items
          and ranking them by the score they get. For example, the title of an
          item could be weighted higher than its author or format, so an item
          with title “May Gibbs” and format “photograph” could appear before an
          item with title “Illustration for Snugglepot and Cuddlepie” and author
          “May Gibbs”. As you can imagine, fine-tuning these weights is a
          difficult process and can be counterbalanced by the presence of other
          sorting criteria. The most common being alphabetical (by author or
          title) and…
        </p>
        <h3 id="year">2. Year</h3>
        <p>
          Dates are another common criteria for search interface sorting, that
          is, when items <em>do</em> have a date associated with them. In the
          Library data set an item can have multiple dates or none at all. For
          the purpose of this project I chose to work with what the data set
          calls <code>published.date_creation</code> and
          ...
          sometimes also represented as a range (e.g. 28 July 1914 to 11
          November 1918) so I selected the year of the lower bound of any range
          I found (e.g.: 1914). In case of no date found it will be zero and not
          displayed.
        </p>
        <h3 id="colour">3. Colour</h3>
        <p>
          I wanted to provide new ways of sorting and looking at the items,
          beyond of what already existed in the data set. I processed all 2
          million images through a
          <a href="http://mkweb.bcgsc.ca/colorsummarizer/">colour summarizer</a>
          that extracts the most prominent colours from an image as well as
          other information such as its histogram. This information is displayed
          above the selected image as coloured boxes, the size of which is
          proportional to the amount of that colour in the image:
        </p>
        <div class="palettes">
          <img
            class="image-palette"
        ...
        <p>
          ...
          <strong>first colour</strong>, which is the most prominent from the
          list of five and sorting by hue, then saturation and, finally,
          lightness. Colour sorting is
          <router-link
            :to="{
              path: '/viewer',
        ...
        <p>
          ...
          <a
            ...
            >great work using machine learning to automatically create
            descriptive keywords</a
          >
          ...
          images are to each other. The process basically provides a score
          between 0 and 1 for 4,096 words for every one of the 2 million images.
          This score represents how confident the algorithm is on a given word
          being present in an image: 0 being total certainty it
          <em>is not</em> present and 1 being total certainty it
          <em>is</em> present. Since there will always be some level of
          uncertainty, zeroes or ones will rarely come up, and more often values
          in between will be returned:
        </p>
        ...
        <p>
          ...
          example, a photo with a cat or a dog “looks like”. These algorithms
          and training sets are hard to produce so there aren’t many available
          and companies that have proprietary versions charge a lot of money for
          their use. Fortunately there are open source data sets, one of which,
          called
          ...
          “Frisbee”, which may not be present in a collection that spans
          hundreds of years to the past and, conversely, contains images for
          words not present in the Imagenet vocabulary. While these words won’t
          be useful to describe the images themselves, it can be useful to find
          images that <em>look similar to the algorithm</em>. The algorithm will
          make mistakes, classifying an image as, for example, a Frisbee, but it
          will make similar mistakes for images that look similar (other images
          that look like Frisbees to the algorithm). Notice how, in the two
          black and white images above, the algorithm has mistakenly classified
          them as “barbershop” and “barber chair” but the images do look
          similar: black and white, a person in a white outfit standing holding
          something, indoors in a relatively asceptic environment. The complete
          process of converting these values into a similarity score will be
          described in a separate post but you can
          <router-link
            :to="{
              path: '/viewer',
      ...
      <section class="data">
        ...
        <p>
          ...
          produced with the help of the awesome DX-Lab and web teams of the
          State Library of New South Wales and all of it is available for you to
      ...
      <section class="acknowledgments">
        <h2>Thanks!</h2>
        <p>
          Thanks to the State Library of New South Wales, State Librarian Dr
          John Vallance and Mitchell Librarian Richard Neville, and especially
          to the DX Lab team: Paula Bray, Kaho Cheung, and Luke Dearnley, for
          their support during this project. Thanks also to Jenna Bain and
          Robertus Johansyah at the web team, and all the Library staff who were
        ...
        <ol class="footnotes-list">
          <li id="fn1" class="footnote-item">
            <p>
              ...
              addressed in a future post but for now let’s say it means
              everything that was digitised at the Library by early February
              2020 and was classified in the selected categories.
