...
export const FormatGroupsType = {
  audio: {
    title: 'Audio',
    id: ['NvvRDeqKwkpxo'],
    children: ['musicalRecordings', 'nonMusicalRecordings', 'audiobooks', 'oralHistory'],
  },
  books: { title: 'Books', id: ['rk34lv59oyl8q'], children: ['books', 'ebooks'] },
  eresources: { title: 'Eresources', id: ['qjD3Axq1q7NXG'], children: ['websites', 'databases', 'software'] },
  journalsMagazines: { title: 'Journals & Magazines', id: ['bR2NK49BNJ3Jy'], children: ['journals'] },
  manuscripts: { title: 'Manuscripts', id: ['bR2NK49BNJ3Jy'], children: ['manuscripts'] },
  maps: {
    title: 'Maps',
    id: ['1d1M8NdvgqxAY'],
  ...
  music: {
    title: 'Music',
    id: ['JwMj8Y50jG3e5'],
    children: ['musicalRecordings', 'manuscriptMusicScores', 'printedMusicScores', 'manuscriptNotatedMusic'],
  },
  newspapers: { title: 'Newspapers', id: ['R5m2rqY0qb0Og'], children: ['newspapers', 'clippingArchival'] },
  objects: {
    title: 'Objects',
    id: ['mp593lA2MErpk'],
  ...
  videoFilms: { title: 'Video & Films', id: ['E62DyPYymyMj6'], children: ['video', 'films'] },
};
export const FormatType = {
  ...
  manuscriptNotatedMusic: { title: 'Manuscript Notated Music', id: 'oWWJDK5PO44me' },
  ...
  nonMusicalRecordings: { title: 'Non-Musical Sound Recordings', id: 'z02KkaA8xXx4E' },
  ...
  manuscriptMusicScores: { title: 'Manuscript Music Scores', id: '9DDK52Ye2G2AD' },
...
export const ItemType = {
  ...
  cartographic: { type: 'cartographic', value: 'Cartographic', name: 'cartographic' },
